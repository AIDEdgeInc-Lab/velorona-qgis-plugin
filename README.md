...
**Velorona QGIS Plugin 1.1.1** — Telecom link evidence, inside QGIS.
...
Plugin Repository. Download `velorona-1.1.1.zip` from the
[v1.1.1 release](https://github.com/AIDEdgeInc-Lab/velorona-qgis-plugin/releases/tag/v1.1.1),
then in QGIS: Plugins → Manage and Install Plugins → Install from ZIP, and
pick that file.

## Status

Version 1.1.1. Packaged and clean-profile install tested for QGIS 4.x.
